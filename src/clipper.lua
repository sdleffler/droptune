-- Copyright Cosmin Apreutesei; licensed under the Boost license v1.0 (see the 
-- clipper subfolder of droptune containing other source)

local ffi = require'ffi'
local C = ffi.load(DROPTUNE_SRC .. "lib/clipper")
